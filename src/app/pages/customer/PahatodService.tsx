...
export function PahatodService() {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-[#0047AB] text-white p-6 shadow-xl">
        <div className="flex items-center gap-4 mb-4 relative z-10">
          ...
          <div>
            <h1 className="text-2xl font-black uppercase italic tracking-tight">Pahatod Service</h1>
            <p className="text-[#D4AF37] text-[10px] font-black uppercase tracking-[0.2em] mt-1">Strategic Parcel Logistics</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-[10px] font-black text-[#0047AB] uppercase tracking-widest mb-2">
              Strategic Pickup Location
            </label>
            <div className="relative">
              <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
              <input
                type="text"
                placeholder="Where should the logistics start?"
          ...
          <div>
            <label className="block text-[10px] font-black text-[#0047AB] uppercase tracking-widest mb-2">
              Strategic Drop-off Destination
            </label>
            <div className="relative">
              <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#D4AF37]" />
              <input
                type="text"
                placeholder="Where is the final delivery point?"
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#0047AB] focus:border-transparent bg-white shadow-sm font-medium"
                required
              />
            </div>
            <p className="text-[10px] text-gray-400 mt-2 italic px-1">Logistics will be coordinated with the nearest available unit.</p>
          </div>
        </div>
