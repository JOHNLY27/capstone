...
import { ArrowLeft, Send, MapPin, DollarSign, Wallet, Navigation } from 'lucide-react-native';
  ...
  const handleDispatch = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        dropoffCoords: dropoffCoords || { latitude: 8.9515, longitude: 125.5280 },
        estimatedDistance: calculatedDistance !== null ? calculatedDistance : 2.8,
  ...
  return (
    ...
    >
        ...
        <View style={styles.body}>
                ...
                <View style={styles.previewDetails}>
                  ...
                  <View style={styles.previewRow}>
                    ...
                    <Text style={styles.previewValueGold}>
                      ₱{settingsStore.getDeliveryFee(calculatedDistance || 0, 'PASUGO').toFixed(2)}
                    </Text>
                  </View>
                  <Text style={styles.previewNote}>
                    *Based on dynamic admin-set rates for PASUGO (including 1.2x route factor).
                  </Text>
                </View>
              )}
            </View>
          ...
          <View style={styles.paymentSelectorContainer}>
            <View style={[styles.paymentCard, styles.activePaymentCard, { flex: 1, paddingVertical: 14 }]}>
              ...
              <Text style={styles.paymentSubtext}>Prepare exact cash amount upon package/errand completion.</Text>
            </View>
          </View>
      ...
      <LocationPickerModal
        ...
        title={activePicker === 'pickup' ? 'Pin Pickup/Transaction Point' : 'Pin Delivery Destination'}
      />
    </KeyboardAvoidingView>
  );
}
