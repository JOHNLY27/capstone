  ...
  const handleDispatch = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        estimatedDistance: calculatedDistance !== null ? calculatedDistance : 3.2,
        price: 0.00,
        details: {
                ...
                <View style={styles.previewDetails}>
                  ...
                  <View style={styles.previewRow}>
                    ...
                    <Text style={styles.previewValueGold}>
                      ₱{settingsStore.getDeliveryFee(calculatedDistance || 0, 'PAHATOD').toFixed(2)}
                    </Text>
                  </View>
                  <Text style={styles.previewNote}>
                    *Based on dynamic admin-set rates for PAHATOD (including 1.2x route factor).
                  </Text>
                </View>
              )}
            </View>
