...
export default function RiderSupportChatScreen() {
  ...
  const fetchMessages = async (silent = false) => {
    ...
    try {
      ...
      console.error('Error fetching rider support messages:', e);
    } finally {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      console.error('Rider send support message error:', e);
      ...
      >
        {messages.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyTitle}>FetchMeUp Pilot Support</Text>
            <Text style={styles.emptyDesc}>
              Need assistance with document verification, GCash cash-outs, service area details, or client issues? Type a message below. The administrator will reply to your thread shortly.
            </Text>
          </View>
        ) : (
          messages.map((msg) => {
